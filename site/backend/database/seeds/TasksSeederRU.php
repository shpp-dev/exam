...
class TasksSeederRU extends Seeder
{
    ...
    public function run()
    {
        ...
        $descriptions = [
            ...
            [
                'problem' => 'На вход в функцию приходит массив целых чисел, а вторым параметром - его размер. Поменяйте в массиве местами четные и следующие за ними (при счете) нечетные числа 0 и 1, 2 и 3, 4 и 5, и т.д. Нужно вернуть отсортированный полученный массив.',
                'note' => '',
                'example' => [
                    'input' => '[1, 4, 3, 2, 0], 5',
                    'output' => '[0, 4, 2, 3, 1]'
