    ...
    public function run()
    {
        ...
        $descriptions = [
            ...
            [
                ...
                'note' => 'Параметром функції передається рядок з математичним виразом. Функція повинна повернути 100, якщо дужки розташовані правильно, в іншому випадку - кількість зайвих дужок.',
                'example' => [
                    'input' => '(2  * (3 + 5)) / 12 + 14)',
                    'output' => '1'
                ]
            ...
            [
                'problem' => 'На вхід функції приходить масив цілих чисел, а другим параметром - його розмір. Поміняйте в масиві місцями парні і наступні за ними (при рахунку) непарні числа 0 і 1, 2 і 3, 4 і 5, і т.д. Потрібно повернути відсортований таким способом масив.',
                'note' => '',
                'example' => [
                    'input' => '[1, 4, 3, 2, 0], 5',
                    'output' => '[0, 4, 2, 3, 1]'
