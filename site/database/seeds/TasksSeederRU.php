...
<I> В этом и следующих задачах вам не нужно писать всю программу, только функцию / метод, которая принимает на вход заданные параметры, обрабатывает их и возвращает (return) необходимые значения, все остальное уже написано нами. Библиотеки, необходимые для выполнения задания также уже подключены, с их списком можно ознакомиться <a class="waves-effect waves-light modal-trigger" href="#programming-info-modal"> здесь. </a> </i>
<br>
<B> Программа должна быть длиной менее 4500 символов.</b>

  <div id="programming-info-modal" class="modal bottom-sheet">
    <div class="modal-content">
      <h4>Предустановки в языках программирования</h4>
      <p>
Библиотеки подключены по мере надобности, поэтому в задачах связанных со строками можно не встретить математической библиотеки и наоборот.
  <h5>Java</h5>
  <ul>
  ...
  <ul>
    ...
    <div class="modal-footer">
      <a href="#!" class=" modal-action modal-close waves-effect waves-green btn-flat">Понятно</a>
    </div>
  </div>',
